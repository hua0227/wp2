...
总结六个 moderate-penalty 候选物在 20% CHOL 和 40% CHOL TRKB-TMD 体系中的 100 ps R2 PBC-aware restrained MD pilot 表现。
...
- 9.2: `C:\TRKB_WP2\ligand_bound_MD\comparison_9.2_20_vs_40`
...
- 六个候选物的 20chol / 40chol 体系都完成了 100 ps。
- 本轮汇总中没有检测到 NaN。
- temperature range 整体维持在约 307-314 K 的 pilot 区间。
- near chains 在 12 个 candidate-system 中都保持为 2。
- severe / close clash 在六个候选物的 comparison 表中都没有再次出现。
...
- 9.2 / L004: 20chol `weak_or_mixed_contact` (98.0% / 100.0% / 42.0%); 40chol `weak_or_mixed_contact` (100.0% / 62.0% / 65.0%); response `interface_retained_but_weaker_contact`.

## F. Gate 1 分类

- Priority A: 19.1 / L003, 17.2 / L010
- Priority B: 14.2 / L002
- Priority C: 2.3 / L006, 6.2 / L008, 9.2 / L004
...
- Candidate summary table: `C:\TRKB_WP2\ligand_bound_MD\WP2_Gate1_summary_with_9.2\tables\WP2_Gate1_candidate_summary.csv`
- Ligand-level summary table: `C:\TRKB_WP2\ligand_bound_MD\WP2_Gate1_summary_with_9.2\tables\WP2_Gate1_ligand_level_summary.csv`
- Report-ready summary table: `C:\TRKB_WP2\ligand_bound_MD\WP2_Gate1_summary_with_9.2\tables\WP2_Gate1_report_ready_summary.csv`
- Figures directory: `C:\TRKB_WP2\ligand_bound_MD\WP2_Gate1_summary_with_9.2\figures`
- PyMOL script: `C:\TRKB_WP2\ligand_bound_MD\WP2_Gate1_summary_with_9.2\pymol\view_gate1_final_structures.pml`

## Update Note: Added 9.2 / L004

- Original Gate 1 summary covered 5 candidates.
- This updated version adds 9.2 / L004.
- 9.2 / L004 priority class: Priority C
- 9.2 / L004 cholesterol response label: interface_retained_but_weaker_contact
- 9.2 / L004 rationale: 9.2 / L004: 20chol weak_or_mixed_contact (TYR13/VAL17/SER20 <5 A = 98.0%/100.0%/42.0%); 40chol weak_or_mixed_contact (= 100.0%/62.0%/65.0%); response interface_retained_but_weaker_contact; assigned Priority C.
- Priority A after adding 9.2: 19.1 / L003, 17.2 / L010
